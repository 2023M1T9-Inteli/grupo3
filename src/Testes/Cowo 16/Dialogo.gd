...
var dialogo_1 = [
	...
	},
	{
		"Name": "Letícia",
		"Choices": [""],
		"Text": "Prazer, sou a Letícia, sua líder e responsável por gerenciar a empresa.",
		"Response": [""],
	},
	{
		"Name": "Letícia",
	...
	
	{
		"Name": "Letícia",
		"Choices": [""],
		"Text": "Com muito esforço e dedicação, poderá alcançar o sonhado desenvolvimento da sua carreira!",
		"Response": [""],
	...
	},
	{
		"Name": "Letícia",
		"Choices": [""],
		"Text": "Para começar o seu primeiro dia, você será responsável por revisar alguns relatórios sobre a comunicação não violenta. Eles são cruciais para garantir a efetividade do nosso trabalho em grupo.",
		"Response": [""],
...
var dialogo_2 = [
	{
		"Name": "Victor",
		"Choices": [""],
		"Text": "Ah, então você é a nova pessoa estagiária... Eu sou o Victor, prazer em te conhecer.",
		"Response": [""],
	},
	{
		"Name": "Victor",
		"Choices": [
			"O prazer é meu, Victor. Estou feliz por começar a trabalhar aqui e tenho certeza que com dedicação vou conseguir aplicar o meu melhor para a empresa e para a equipe!",
...
var dialogo_3 = [
	...
	
	{
		"Name": "Letícia",
		"Choices": [""],
		"Text": " Lembre-se dos treinamentos que recebeu durante o processo de integração, eles serão fundamentais.",
		"Response": [""],
	},
...
var dialogo_5 = [ #Armazena diálogo 5
	{
		"Name": "Victor",
		"Choices": [
			"Ela pediu que trabalhássemos em algumas ideias para o processo seletivo de contratação da CoWo.Vamos começar decidindo o que esperamos das pessoas candidatas?",
			"Ela pediu para que trabalhássemos em algumas ideias para o processo seletivo de contratação da CoWo.",
...

	{
		"Name": "Victor",
		"Choices": [
			"Acho que é importante que as pessoas candidatas tenham habilidades técnicas, mas também habilidades interpessoais e de comunicação.",
...

	{
		...
		"Text": "Então, eu estava pensando em incluir uma atividade em que as pessoas candidatas precisam resolver um problema em equipe. Isso testará não apenas suas habilidades técnicas, mas também suas habilidades de trabalho em equipe.",
		"Response": [
			"Parece uma boa ideia!",
	...
	
	{
		"Name": "Victor",
		"Choices": [
			"Eu não tenho certeza se essa é a melhor ideia. Pode ser que algumas pessoas candidatas não se sintam confortáveis em falar sobre si mesmas e isso pode prejudicar seu resultado no processo seletivo.",
			"Acho que a apresentação pode ser uma boa ideia.",
			"Ah, sim, porque toda pessoa adora falar sobre si mesma.",
			],
		"Text": " E se incluirmos uma atividade em que as pessoas candidatas precisam fazer uma apresentação sobre si mesmas?",
		"Response": [""],
		},

	{
		"Name": "Victor",
		"Choices": [""],
		"Text": "Entendo seu ponto, mas acho que também é importante que as pessoas candidatas sejam capazes de se apresentar de forma clara e persuasiva.",
		"Response": [""],
		},
...
var dialogo_6 = [ #Armazena o dialogo 6
	...
	
	{
		"Name": "Letícia",
		"Choices": [
			"Claro, Letícia. Estou sempre buscando melhorar, então não vejo a hora de saber o que você registrou",
		...
		"Text": "Você é uma pessoa valiosa da nossa equipe e estou muito feliz por ter você conosco. Eu revisei seus relatórios recentes e gostaria de dar um feedback sobre o seu desempenho.",
...
var dialogo_7 = [ #Armazena diálogo 7
	{
		"Name": "Sr. Facundes",
		"Choices": [""],
		"Text": "Olá, Prazer em te conhecer, eu sou o Facundes, e sou o CEO da COWO e você recebeu uma promoção para a Supervisão.",
		"Response": [""],
	...
	},
	{
		"Name": "Sr. Facundes",
		"Choices": [""],
		"Text": " Espero que você continue se empenhando em seu trabalho, já que teremos várias tarefas. Se conseguir concluir as tarefas com qualidade terá meu respeito e reconhecimento.",
		"Response": [""],
	...
	
	{
		"Name": "Sr. Facundes",
		"Choices": [
			"Olá Sr. Facundes, muito obrigado! Me empenharei em ajudar o Simon a organizar seu trabalho.",
			"Olá Sr. Facundes, Irei organizar o trabalho do Simon.",
...
var dialogo_8 = [ #Armazena diálogo 8
	{
		"Name": "Simon",
		"Choices": [
			"Bem-vindo, Simon! A partir de agora serei sua liderança e da equipe. Estou aqui para te apoiar em tudo o que precisar, mas também espero que você mantenha um alto nível de desempenho e comprometimento.",
			"Olá, Simon! Prazer em conhecê-lo. Recentemente recebi a promoção para esse cargo e estou aqui para me apresentar e disponibilizar meu apoio em sua jornada aqui na empresa, caso precise.",
			"Prazer, Simon! Recebi uma promoção e agora sou líder dessa equipe, espero que você esteja ciente de que precisa trabalhar duro e mostrar que merece estar aqui.",
				],
	...
	},
	{
		"Name": "Simon",
		"Choices": [
			"Claro, além de conhecer você, vim para delegar sua primeira tarefa, que é muito importante para o projeto em que estamos trabalhando, e dar um feedback sobre o que observamos durante o seu processo seletivo.",
			"Preciso dar um feedback sobre o que observamos durante o seu processo seletivo, mas também estou com sua primeira tarefa, não é nada muito complicado. Posso te passar as informações agora?",
	...
	},
	{
		"Name": "Simon",
		"Choices": [
			"Certo! Vamos começar com as observações do seu processo seletivo. Eu já preparei um feedback detalhado sobre o seu desempenho e vou enviar para você imediatamente por e-mail.",
			...
			"Vamos começar logo com o feedback sobre o que observamos durante seu processo seletivo. Espero que possa começar já levando a sério minhas sugestões. Vou enviá-lo por e-mail, espero que tenha disposição para lê-lo e melhorar o seu desempenho.",
		],
		"Text": "Será que você poderia me mostrar a tarefa e as observações que fizeram durante o meu processo seletivo? Preciso saber, estou empolgado para começar!",
		"Response": [""],
	},
...
var dialogo_9 = [ #Armazena diálogo 9
	{
		...
		"Partindo para o próximo assunto, a sua primeira tarefa não é muita coisa... Apenas precisamos documentar as alterações do novo processo seletivo e enviar para o sistema. Agradeço se você puder lidar com isso.",
...
var dialogo_10 = [
	...
	},
	{
		"Name": "Simon",
		"Choices": [
			"Entendo que o Victor precisou de ajuda, mas é importante lembrar que a tarefa que eu solicitei a você era para ser entregue hoje. Precisamos nos concentrar nisso imediatamente para garantir que ainda possamos cumprir o prazo. Por favor, informe-me sobre qualquer nova dificuldade que encontrar.",
		...
		"Text": "O Victor me pediu para realizar uma tarefa que ele considera mais urgente. Ele pediu que eu o ajudasse a montar uma apresentação importante para uma reunião com os diretores. Você também havia me pedido para concluir essa tarefa, mas achei que deveria priorizar a solicitação do Victor. Eu poderia trabalhar nesta tarefa agora e concluir o quanto antes para compensar o atraso.",
		"Response": [
...
var dialogo_11 = [
	...
	},
	{
		"Name": "Victor",
		"Choices": [
			"Sim. Eu entendo que você precisava de ajuda para sua tarefa, mas a tarefa que eu solicitei ao Simon era mais importante para o resultado da empresa como um todo. Será que podemos priorizar melhor nossas tarefas no futuro?",
...
var dialogo_12 = [
	{
		"Name": "Sr. Facundes",
		"Choices": [
			"Houve um problema de comunicação entre mim e o Victor, mas resolvi a situação e o estagiário já começou. Pode ter certeza que mesmo assim vamos entregar no prazo.",
		...
		"Response": [
			"Entendi. Agradeço por me informar e aguardo a conclusão.",
			"Entendi.",
			"Espero que vocês estejam considerando os interesses da empresa como prioridade, senão as coisas podem se complicar.",
			],
	},
	{
		"Name": "Sr. Facundes",
...
var dialogo_13 = [
	{
		...
		"Text": "Olá, que bom que veio. Notei que conseguiu fazer o envio dos dados, definitivamente você não fez mais que sua obrigação, entretanto, não deixa de ser impressionante como você lidou com o problema com agilidade. Mas enfim, te chamei aqui para lhe parabenizar, é surpreendente o quão rápido você evoluiu, por mais que tenha cometido erros é nítido que você se esforça muito. Por isso, ao observar como tem sido seu desempenho desde que entrou nesta empresa, tomei a decisão de fazer um reconhecimento formal destacando seu resultado.",
	...
	},
	{
		...
		"Text": "Ah, quase me esqueci, elaborei um relatório com seu desempenho nos últimos dias, é muito importante que você o leia e entenda como melhorar para seus próximos desafios profissionais. Até amanhã!",
