...
onready var text = get_parent().get_node("Dialogo").dialogo_2
...
func _on_Leticia_pressed() -> void:
	#Leva o jogador para a cena da Leticia
	get_tree().change_scene_to(load("res://src/Leticia/Cena2Leticia.tscn"))
